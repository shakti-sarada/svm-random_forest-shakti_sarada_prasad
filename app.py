...
model = pickle.load(open('svmmodel_rbf.pkl', 'rb')) 
...
def main():
   ...
   """
    ...
    st.header("Item Purchase Prediction using SVM Algorithm (RBF Kernel Function) and Random Forest Algorithm")
    ...
    resul=""
    if st.button("SVM RBF Function Prediction"):
    ...
    if st.button("About"):
      st.header("Developed by Shakti Sarada Prasad")
      st.subheader("Student , Department of Computer Science Engineering")
    html_temp = """
